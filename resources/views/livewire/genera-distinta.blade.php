                ...
                <div class="inline-flex w-full mb-1">
                    <div class="w-full shadow pt-1 mb-2 mt-2 bg-gray-300 rounded " >
                        <div class="grid grid-cols-10 gap-x-2  ml-5 mr-5">
                                ...
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;" wire:click='stampa_cites'>Stampa CITES</button>
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;" wire:click='stampa_ce'>Stampa CE</button>
