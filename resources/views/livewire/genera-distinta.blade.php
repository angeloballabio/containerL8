    ...
    <div>
        ...
        <div class="inline-flex w-full">
                    ...
                    <div class="w-1/2">
                        <div class="shadow p-2 mb-2 bg-gray-300 rounded">
                            <div class="grid grid-cols-4 gap-0">
                                ...
                                <div>
                                    <input type="checkbox"  style="height: 20px" wire:model="attrezzi_cucina" {{ $attrezzi_cucina ? 'checked' : ''}} > <label for="attrezzi_cucina" class="align-top" style="height: 20px">Strmenti cuc inox</label>
                                </div>
                                <div>
            ...
            <div class="w-full border ">
                ...
                {{-- @livewire('azioni-distinta',['id' => $operazione->id, 'f_id' => $fornitore_id]) --}}
                {{-- <livewire:azioni-distinta /> --}}
                {{-- </div> --}}
                <div class="inline-flex w-full mb-1">
                    <div class="w-full shadow pt-1 mb-2 mt-2 bg-gray-300 rounded " >
                        <div class="grid grid-cols-9 gap-x-2  ml-5 mr-5">
                                ...
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;">Stampa sanitari</button>
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;">Stampa AGE</button>
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;">Stampa CITES</button>
                                ...
                                <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-1 mb-1 " style="height: 25px; vertical-align: middle; padding-top: 0px;" wire:click='semi_automatico'>Acq. semi auto</button>
