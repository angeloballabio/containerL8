<div>
    <h1 class="text-center">Gestione trasportatori</h1>
    <div>
        <div class="inline-flex">
            <div class="w-1/2 border ">
                {{-- <livewire:elenco-trasportatori /> --}}
                <table  style="width: 100%; border-collapse: collapse; border: 1px solid black; ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-collapse: collapse; border: 1px solid black; background-color: #6699ff; color: white;" wire:click="$emit('TrasportatoreSelezionato',{{ $trasportatore->id }})" >{{ $trasportatore->soprannome }}</td>
                            ...
                            @else
                            <td style="border-collapse: collapse; border: 1px solid black; " wire:click="$emit('TrasportatoreSelezionato',{{ $trasportatore->id }})" >{{ $trasportatore->soprannome }}</td>
            ...
            <div class="w-1/2 border">
                <livewire:dati-trasportatore />
                <livewire:azioni-trasportatore />
            </div>
        </div>
    </div>
</div>
